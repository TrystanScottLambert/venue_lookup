...
const VENUES: &[(&str, &str)] = &[
    ...
    ("AGRI G017", "AGRI: [  G017] Central Undergrad Computer Lab"),
    ...
    ("ALBGSMRF G03", "ALBGSMRF: [  G03] GSMRF Boardroom (10)"),
    ("ALBGSMRF G04", "ALBGSMRF: [  G04] GSMRF Meeting Room (8)"),
    ...
    ("ARTS 227", "ARTS: [ 227] General purpose teaching space"),
    ...
    ("BOBIA1 G11", "BOBIA1: [  G11] East Undergrad Computer Lab"),
    (
        "BOBIA2 G09",
    ...
    ("EDUC 117", "EDUC: [ 117] ALVA BIM Master Suit Computer Lab"),
    ...
    ("EZONECENT G04", "EZONECENT: [  G04] Student Project Area"),
    ("EZONECENT G05", "EZONECENT: [  G05] Materials Testing Lab"),
    ("EZONECENT G07", "EZONECENT: [  G07] Hydraulics Lab"),
    ("EZONENTH G03", "EZONENTH: [  G03] EZONE Social"),
    ("EZONENTH G10", "EZONENTH: [  G10] Specialist Hardware Lab"),
    ...
    ("PSYC 145A", "PSYC: [ 145A] Psychology Computer Lab (North)"),
    ...
    ("QE2M B05", "QE2M: [  B05] FA Hadley Museum Basement Lab"),
    ("QE2M", "QE2M: [  G05 ]  WET Lab Research"),
    ...
    ("QE2M G28", "QE2M: [  G28] WET Lab Teaching Pharmacology"),
    ...
    ("REIDLIB G09", "REIDLIB: [  G09] Hemsley Learning Suite"),
    ...
    ("SSEH G100", "SSEH: [  G100] Health & Rehabilitation Clinic"),
    ...
    ("WSC 109A", "WSC: [  109A] Water Sports Complex Room 9A"),
    ("WSC 109B", "WSC: [  109B] Water Sports Complex Room 9B"),
